...
struct TextureFactory final
{
    ...
    static void Load3DTexturesInPath(const std::filesystem::path& basePath, size_t channelCount, ID3D12Device* pDevice, ID3D12GraphicsCommandList* pCommandList, ResourceCodex& codex);
    ...
    static bool Load3DTextureFromSlices(std::filesystem::path directoryPath, size_t channelCount, ID3D12Device* pDevice, ID3D12GraphicsCommandList* pCommandList, ResourceCodex& codex);
    ...
    static void CreateProceduralNVDFTexture(const wchar_t* name, ID3D12Device* pDevice, ID3D12GraphicsCommandList* pCommandList, ResourceCodex& codex);
    static void CreateRaymarchCacheTexture(ID3D12Device* pDevice, ID3D12GraphicsCommandList* pCommandList, ResourceCodex& codex);
};
